...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public Usuario obtenerUsuarioPorId(Long id) {
        return usuarioRepository.findById(id).orElseThrow(() ->
                new UsernameNotFoundException("No se encontró el usuario con el id: "+id));
    }
    ...
    public void actualizarRolUsuarioArtista(Long id, Artista artista) {
        ...
        if (usuario == null) {
            throw new UsernameNotFoundException("actualizarRolUsuarioArtista: Usuario no encontrado");
        }
